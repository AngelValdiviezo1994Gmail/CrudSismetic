...
namespace Module.Security.Infraestructure.DTO
{
    public class UserDTO
    {
        ...
        public string UsuNombreCompleto
            => string.IsNullOrEmpty(UsuSegundoNombre)
            ? $"{UsuPrimerNombre} {UsuPrimerApellido} {UsuSegundoApellido}"
            : $"{UsuPrimerNombre} {UsuSegundoNombre} {UsuPrimerApellido} {UsuSegundoApellido}";
        public string UsuNombres
            => string.IsNullOrEmpty(UsuSegundoNombre)
            ? $"{UsuPrimerNombre}"
            : $"{UsuPrimerNombre} {UsuSegundoNombre}";
        public string UsuApellidos
            => string.IsNullOrEmpty(UsuSegundoApellido)
            ? $"{UsuPrimerApellido}"
